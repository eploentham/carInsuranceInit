...
namespace carInsuranceInit.objdb
{
    public class SedanAgeCarDB
    {
        ...
        private void initConfig()
        {
            ...
            sac.sedanAgeCarActive = "sedan_age_car_active";
        ...
        public DataTable selectAll()
        {
            ...
            sql = "Select * From " + sac.table + " Where "+sac.sedanAgeCarActive+"='1'";
        ...
        private String insert(SedanAgeCar p)
        {
            ...
            if (p.sedanAgeCarActive.Equals(""))
            {
                p.sedanAgeCarActive = "1";
            }
            ...
            sql = "Insert Into "+sac.table+" ("+sac.pkField+","+sac.sedanAgeCar+","+
                sac.RateTInsur1+","+sac.RateTInsur2+","+sac.RateTInsur3+","+sac.sedanAgeCarActive+") "+
        ...
        {
            String sql = "", chk = "";
            sql = "Update  " + sac.table+" Set "+sac.sedanAgeCarActive+"='3' "+
                "Where "+sac.sedanAgeCarId+"='"+sacId+"'";
            chk = conn.ExecuteNonQuery(sql);
            return chk;
        }
    }

...
namespace carInsuranceInit.objdb
{
    public class SedanPaDB
    {
        ...
        private void initConfig()
        {
            ...
            spa.sedanPaActive = "sedan_pa_active";
        ...
        public DataTable selectAll()
        {
            ...
            sql = "Select * From " + spa.table + " Where " + spa.sedanPaActive + "='1'";
        ...
        public String insert(SedanPa p)
        {
            ...
            sql = "Insert Into " + spa.table + " (" + spa.pkField + "," + spa.sedanPa + "," +
                spa.RateTInsur1 + "," + spa.RateTInsur2 + "," + spa.RateTInsur3+","+spa.sedanPaActive + ") " +
                "Values('" + p.sedanPaId + "','" + p.sedanPa + "','" +
                p.RateTInsur1 + "','" + p.RateTInsur2 + "','" + p.RateTInsur3+"','"+p.sedanPaActive + "')";
            try
            {
        ...
        {
            String sql = "", chk = "";
            sql = "Update  " + spa.table + " Set " + spa.sedanPaActive + "='3' "+
                "Where "+spa.sedanPaId+"='"+sacId+"'";
            chk = conn.ExecuteNonQuery(sql);
            return chk;
        }
    }
